...
const Register = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    age: '', gender: 'Male', specialization: '', experience: '', hospitalName: '', address: ''
  });
    ...
    <div className="Register-container">
      <div className="Register-card">
        ...
        <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem', justifyContent: 'center' }}>
          <button 
            className={`btn ${role === 'patient' ? 'btn-onclick' : 'btn-noclick'}`}
            onClick={() => setRole('patient')}
          >
            Patient Registration
          </button>
          <button 
            className={`btn ${role === 'doctor' ? 'btn-onclick' : 'btn-noclick'}`}
            ...
            <>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div className="form-group">
                  ...
                  <input type="text" name="specialization" className="form-control" onChange={handleChange} required />
                </div>
                <div className="form-group">
              ...
              <div className="form-group">
                ...
                <input type="text" name="hospitalName" className="form-control" onChange={handleChange} required />
              </div>
              <div className="form-group">
                <label>Clinic Address</label>
                <input type="text" name="address" className="form-control" onChange={handleChange} required placeholder="Enter full clinic address" />
              </div>
            </>
          )}

          <button type="submit" className="btn btn-Color" style={{ width: '100%', marginTop: '1rem' }}>Register</button>
        </form>
      </div>
    </div>
  );
